...
class HBHorizontalTableView: UIView, UITableViewDataSource, UITableViewDelegate {
    ...
    func setTableView() {
        ...
        let cellNib: UINib = UINib(nibName: "HBAppCell", bundle: nil)
    ...
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return delegate!.htableView(self, numberOfRowsInSection: section)
    }
    
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell: UITableViewCell = delegate!.htableView(self, cellForRowAtIndexPath: indexPath)
